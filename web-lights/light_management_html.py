def webpage(states, temperature):
    ...
    html = f"""
        ...
        <article>
            <body>
            <div><img src="https://www.raspberrypi.org/app/uploads/2011/10/Raspi-PGB001.png" alt="Raspberry Pi Logo"></div>
            <div class="container">
            <h3>Smart Office Control</h3>
            </div>
            <h4>Current Temperature: {
            f'<span style="color:red;">{temperature}°C</span>' if temperature > 30 else f'{temperature}°C'
            } </h4>
            <fieldset class="checkbox-group">
                <legend class="checkbox-group-legend">Lighting control</legend>
                <div class="checkbox">
                    <label class="checkbox-wrapper">
                        <input type="checkbox" class="checkbox-input {"checked" if led1=="true" else '' }" />
                        <span class="checkbox-tile">
                            ...
                            <span class="checkbox-label">LIGHT 1</span>
                        </span>
                    </label>
                </div>
                <div class="checkbox">
                    <label class="checkbox-wrapper">
                        <input type="checkbox" class="checkbox-input" checked {"checked" if led2=="true" else '' } />
                        <span class="checkbox-tile">
                            <span class="checkbox-icon">
                                <svg fill="#000000" height="200px" width="200px" version="1.1" id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <span class="checkbox-label">LIGHT 2</span>
                        </span>
                    </label>
                </div>
                <div class="checkbox">
                    <label class="checkbox-wrapper">
                        <input type="checkbox" class="checkbox-input" {"checked" if led3=="true" else '' } />
                        <span class="checkbox-tile">
                            <span class="checkbox-icon">
                                <svg fill="#000000" height="200px" width="200px" version="1.1" id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <span class="checkbox-label">LIGHT 3</span>
                        </span>
                    </label>
                </div>
                <div class="checkbox">
                    <label class="checkbox-wrapper">
                        <input type="checkbox" class="checkbox-input" {"checked" if led4=="true" else '' } />
                        <span class="checkbox-tile">
                            <span class="checkbox-icon">
                                <svg fill="#000000" height="200px" width="200px" version="1.1" id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <span class="checkbox-label">LIGHT 4</span>
                        </span>
                    </label>
                </div>
                <div class="checkbox">
                    <label class="checkbox-wrapper">
                        <input type="checkbox" class="checkbox-input" {"checked" if led5=="true" else '' } />
                        <span class="checkbox-tile">
                            <span class="checkbox-icon">
                                <svg fill="#000000" height="200px" width="200px" version="1.1" id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <span class="checkbox-label">LIGHT 5</span>
                        </span>
                    </label>
                </div>
                <div class="checkbox">
                    <label class="checkbox-wrapper">
                        <input type="checkbox" class="checkbox-input" {"checked" if led6=="true" else '' } />
                        <span class="checkbox-tile">
                            <span class="checkbox-icon">
                                <svg fill="#000000" height="200px" width="200px" version="1.1" id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <span class="checkbox-label">LIGHT 6</span>
                        </span>
                    </label>
                </div>
                 <div class="container">
        ...
        $(document).ready(function () {{
            {{
                $(".checkbox-input").change(function () {{
                    {{
                        var led_states = [];
                        led_states.push("led1=" + ($("#checkbox-1").is(":checked") ? "true" : "false"));
                        led_states.push("led2=" + ($("#checkbox-2").is(":checked") ? "true" : "false"));
                        led_states.push("led3=" + ($("#checkbox-3").is(":checked") ? "true" : "false"));
                        led_states.push("led4=" + ($("#checkbox-4").is(":checked") ? "true" : "false"));
                        led_states.push("led5=" + ($("#checkbox-5").is(":checked") ? "true" : "false"));
                        led_states.push("led6=" + ($("#checkbox-6").is(":checked") ? "true" : "false"));
